...
def main():
    ...
    PC_BACKUP_BASE = Path(r'C:\Users\bSlop\Retro Game Files\ROMs - 1G1R\SNK\NeoGeo Pocket')
    PC_BACKUP_GAMELIST = PC_BACKUP_BASE / 'media' / 'gamelist.xml'
    
    # RetroBat - normal structure
    RETROBAT_BASE = Path(r'C:\RetroBat\roms\ngp')  # Update this to your actual path
    RETROBAT_GAMELIST = RETROBAT_BASE / 'gamelist.xml'
    
    # Output directory
    OUTPUT_DIR = Path(r'C:\Users\bSlop\Desktop\Unified_Gamelists')
